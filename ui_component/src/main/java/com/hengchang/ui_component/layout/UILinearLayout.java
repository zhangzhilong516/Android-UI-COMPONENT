...
import com.hengchang.ui_component.alpha.UIAlphaLinearLayout;
...
public class UILinearLayout extends UIAlphaLinearLayout implements UILayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new UILayoutHelper(context, attrs,R.styleable.UILinearLayout, defStyleAttr, this);
