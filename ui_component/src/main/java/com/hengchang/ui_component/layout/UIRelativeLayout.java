...
import com.hengchang.ui_component.alpha.UIAlphaRelativeLayout;
...
public class UIRelativeLayout extends UIAlphaRelativeLayout implements UILayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new UILayoutHelper(context, attrs, R.styleable.UIRelativeLayout, defStyleAttr, this);
