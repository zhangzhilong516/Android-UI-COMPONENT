...
import com.hengchang.ui_component.alpha.UIAlphaButton;
 ...
 * description：
 */
public class UIButton extends UIAlphaButton implements UILayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new UILayoutHelper(context, attrs, R.styleable.UIButton,defStyleAttr, this);
