...
package com.hengchang.ui_component.layout;
 ...
 * description：
 */
public class UILayoutHelper implements UILayout {
    ...
    private int mRadius;
    private @UILayout.HideRadiusSide int mHideRadiusSide = HIDE_RADIUS_SIDE_NONE;
    ...
    public UILayoutHelper(Context context, AttributeSet attributeSet,int[] attrs, int defAttr, View owner) {
        mContext = context;
        ...
        mShadowAlpha = UIResHelper.getAttrFloatValue(context, R.attr.ui_layout_shadow_alpha);
        mBorderRect = new RectF();

        int radius = 0, shadow = 0;
        boolean useThemeGeneralShadowElevation = false;
        if (null != attrs || defAttr != 0) {
            TypedArray ta = context.obtainStyledAttributes(attributeSet, attrs, defAttr, 0);
        ...
        if (shadow == 0 && useThemeGeneralShadowElevation) {
            shadow = UIResHelper.getAttrDimen(context, R.attr.ui_layout_shadow_elevation);
    ...
    public void setUseThemeGeneralShadowElevation() {
        mShadowElevation = UIResHelper.getAttrDimen(mContext, R.attr.ui_layout_shadow_elevation);
    ...
    @Override
    public void setRadius(int radius, @UILayout.HideRadiusSide int hideRadiusSide) {
    ...
    @Override
    public void setRadiusAndShadow(int radius, @UILayout.HideRadiusSide int hideRadiusSide, int shadowElevation, float shadowAlpha) {
