...
public class UIAlertDialog extends Dialog implements DialogInterface{
    ...
    public UIAlertDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            this(context, R.style.UITheme_Dialog);
        }
        ...
        /**
         * Creates an {@link UIAlertDialog} with the arguments supplied to this
         * builder.
         * <p/>
        ...
        public UIAlertDialog create() {
            ...
            final UIAlertDialog dialog = new UIAlertDialog(P.mContext, P.mThemeResId);
