 ...
 * </ul>
 */
public class UIRoundButtonDrawable extends GradientDrawable {
    ...
    public static UIRoundButtonDrawable fromAttributeSet(Context context, AttributeSet set,int[] attrs, int defStyleAttr) {
        TypedArray typedArray = context.obtainStyledAttributes(set, attrs, defStyleAttr, 0);
        ColorStateList colorBg = typedArray.getColorStateList(R.styleable.UIRoundButton_ui_backgroundColor);
        ColorStateList colorBorder = typedArray.getColorStateList(R.styleable.UIRoundButton_ui_borderColor);
        int borderWidth = typedArray.getDimensionPixelSize(R.styleable.UIRoundButton_ui_borderWidth, 0);
        boolean isRadiusAdjustBounds = typedArray.getBoolean(R.styleable.UIRoundButton_ui_isRadiusAdjustBounds, false);
        int mRadius = typedArray.getDimensionPixelSize(R.styleable.UIRoundButton_ui_radius, 0);
        int mRadiusTopLeft = typedArray.getDimensionPixelSize(R.styleable.UIRoundButton_ui_radiusTopLeft, 0);
        int mRadiusTopRight = typedArray.getDimensionPixelSize(R.styleable.UIRoundButton_ui_radiusTopRight, 0);
        int mRadiusBottomLeft = typedArray.getDimensionPixelSize(R.styleable.UIRoundButton_ui_radiusBottomLeft, 0);
        int mRadiusBottomRight = typedArray.getDimensionPixelSize(R.styleable.UIRoundButton_ui_radiusBottomRight, 0);
        typedArray.recycle();

        UIRoundButtonDrawable bg = new UIRoundButtonDrawable();
