...
public class UIRoundButton extends UIAlphaButton {
    ...
    public UIRoundButton(Context context, AttributeSet attrs) {
        super(context, attrs, R.attr.UIRoundButtonStyle);
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        UIRoundButtonDrawable bg = UIRoundButtonDrawable.fromAttributeSet(context, attrs, R.styleable.UIRoundButton, defStyleAttr);
