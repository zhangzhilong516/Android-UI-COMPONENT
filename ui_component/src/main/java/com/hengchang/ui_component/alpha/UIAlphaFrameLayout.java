 ...
 */
public class UIAlphaFrameLayout extends FrameLayout implements QMUIAlphaViewInf {
    ...
    public UIAlphaFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UIAlphaFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
