...
public class UIAlphaViewHelper {
    ...
    public UIAlphaViewHelper(@NonNull View target) {
        ...
        mPressedAlpha = UIResHelper.getAttrFloatValue(target.getContext(), R.attr.ui_alpha_pressed);
        mDisabledAlpha = UIResHelper.getAttrFloatValue(target.getContext(), R.attr.ui_alpha_disabled);
    }

    public UIAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
