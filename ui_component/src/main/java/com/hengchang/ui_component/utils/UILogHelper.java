 ...
 * @des: Log打印工具类
 */
public final class UILogHelper {
    private static final String TAG = "UILogHelper";
    ...
    public static void init(boolean isDebug,JSONConvert jsonConvert) {
        mIsDebug = isDebug;
    ...
    public static void json(String tag, Object obj) {
        printJson(Log.DEBUG, tag, mJsonConvert.toJSONString(obj));
    }
...
//        printClassInfo(logType, tag);
    ...
    private static int getStackOffset(StackTraceElement[] trace) {
        for (int i = 0; i < trace.length; i++) {
            ...
            if (name.equals(UILogHelper.class.getName())) {
                return i + 4;
            }
        }
        return -1;
