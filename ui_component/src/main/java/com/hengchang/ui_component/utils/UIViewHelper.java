...
public class UIViewHelper {
     ...
     * 获取activity的根view
     */
    public static View getActivityRoot(AppCompatActivity activity) {
    ...
    public static void playViewBackgroundAnimation(final View v, @ColorInt int startColor, @ColorInt int endColor, long duration, int repeatCount, int setAnimTagId, final Runnable endAction) {
        ...
        UIViewHelper.setBackgroundColorKeepPadding(v, startColor);
        ...
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                UIViewHelper.setBackgroundColorKeepPadding(v, (Integer) animation.getAnimatedValue());
            }
        });
        if (setAnimTagId != 0) {
